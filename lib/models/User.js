...
const { likedEveningsBySimilarUsers } = require('./user-aggregation');
...
userSchema.statics.likedEvenings = function(keyword, zipcode) {  // return Promise.resolve(likedEveningsBySimilarUsers(keyword, zipcode));
    return this.aggregate(likedEveningsBySimilarUsers(keyword, zipcode));
};
