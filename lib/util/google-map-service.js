...
const getPlacesUrl = ({ lat, lng }, type, keyword) => `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${lat} ${lng}&radius=1500&type=${type}&keyword=${keyword}&key=${apiKey}`;
