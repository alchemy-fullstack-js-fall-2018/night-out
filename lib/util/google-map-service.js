...
const getPlacesUrl = ({ lat, lng }, types) => `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${lat} ${lng}&radius=1500&type=${types}&key=${apiKey}`;
...
const getPlaces = (location, types) => {
    const url = getPlacesUrl(location, types);
